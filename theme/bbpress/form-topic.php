		...
		<form id="new-post" name="new-post" method="post">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						<input type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" placeholder="Title" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
					</p>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) ) : ?>
						...
						<p>
							<input type="text" value="<?php bbp_form_topic_tags(); ?>" placeholder="Tags (comma separated)" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> />
						</p>
					...
					<?php if ( bbp_is_subscriptions_active() && ! bbp_is_anonymous() && ( ! bbp_is_topic_edit() || ( bbp_is_topic_edit() && ! bbp_is_topic_anonymous() ) ) ) : ?>
						...
						<?php do_action( 'bbp_theme_before_topic_form_subscriptions' ); ?>
							...
							<input hidden name="bbp_topic_subscription" id="bbp_topic_subscription" type="checkbox" value="bbp_subscribe" checked="true" />
